//
//  HandledAttListViewController.swift
//  SeulMae
//
...
class HandledAttListViewController: UIViewController {
    ...
    let reuseIdentifier = "handled-att-reuse-id"
    ...
    func configureTableView() {
        ...
        let emptyView = SMEmptyView(message: "완료한 작업이 없어요")
